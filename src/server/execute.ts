/**
 * Google Gemini adapter — execute single agent run.
 *
 * v0.0.1: STUB.
 *
 * Strategy: streaming OpenAI-format HTTP client targeting
 *   https://generativelanguage.googleapis.com/v1beta/chat/completions
 * with Bearer \$GEMINI_API_KEY.
 *
...
export async function execute(): Promise<never> {
  throw new Error("gemini-paperclip-adapter v0.0.1 is a scaffold; execute() not yet implemented");
}
